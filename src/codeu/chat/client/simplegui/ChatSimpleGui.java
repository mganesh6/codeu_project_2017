  ...
  public static JMenuBar menuBar(){
	...
	topMenuItem.addActionListener(new ActionListener(){
	  ...
	  final String howToUseMessage = "To use this application, you must first add a user and create a password for the user. "
									...
									+ "To add a user:\n"
									+"1) Click the Add button and enter the user's name and a password in the popup\n"
                                    ...
                                    +"To send a message:\n"
			 						+"1) After logging signing in a user and choosing a conversation, type your message in the white text editor above the Send Message button\n"
			    					+"2) Once you are done typing your message, either press the Send Message button, ENTER, or RETURN\n\n"
                                    +"To search the current conversations:\n"
